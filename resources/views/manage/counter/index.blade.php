            ...
            <div class="row">
                <div class="col-12">
                    <form action="">
                        <div class="row">
                            <div class="col-md-4">
                                <a data-toggle="modal" data-target="#Add-Modal" style="color: white"
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $index+1 }}</td>
                                <td>
                                    <i class="fa {{ $counter->icon }} fa-2x" aria-hidden="true"></i>
                                </td>
                                <td>
                                    {{ $counter->header }}
                                </td>
                                ...
                                <td>
                                    <a data-toggle="modal" data-target="#Edit-Modal-{{ $counter->id }}"
                                    ...
                                    <button type="submit" class="btn btn-danger btn-sm delete" data-toggle="modal"
                                        data-target="#Delete-Modal-{{ $counter->id }}"><i class="fa fa-trash mr-0"></i>
                                    </button>
                                </td>
                            </tr>
                            @endforeach
...
<div class="modal fade" id="Add-Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('manage.counter.store') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
...
<!-- Update Modal -->
<div class="modal fade" id="Edit-Modal-{{ $counter->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit : {{ $counter->header }}l</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('manage.counter.update', $counter->id) }}" method="POST"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="header">Header</label>
                        <input type="text" name="header" value="{{ $counter->header }}" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="icon">Icon</label> ( <i class="fa {{ $counter->icon }} fa-1x"
                            aria-hidden="true"></i> )
                        <select class="form-control" name="icon" required>
                            <option value="{{ $counter->icon }}" selected> {{ $counter->icon }}</option>
                            <option value="fa-align-left">&#xf036; fa-align-left</option>
                            <option value="fa-align-right">&#xf038; fa-align-right</option>
                            <option value="fa-amazon">&#xf270; fa-amazon</option>
                            <option value="fa-ambulance">&#xf0f9; fa-ambulance</option>
...
<!-- Delete Modal -->
<div class="modal fade" id="Delete-Modal-{{ $counter->id }}" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to delete "{{ $counter->header }}"?
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('manage.counter.destroy', $counter->id) }}" method="POST"
                enctype="multipart/form-data">
                {{ csrf_field() }}
                @method('delete')
                <div class="modal-footer">
