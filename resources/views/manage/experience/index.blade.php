                    ...
                    <table class="table" id="education_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                @if ($experience->to == "")
                                    {{ date('F Y', strtotime($experience->from)) }} - PRESENT 
                                @else
                                    {{ date('F Y', strtotime($experience->from)) }} - {{ date('F Y', strtotime($experience->to)) }}
                                @endif
                                </td>
                                <td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('manage.experience.update' , $experience->id) }}"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="place">Place or Company Name</label>
                                                    <input type="text" name="place"value="{{ $experience->place }}" placeholder="Enter company name" class="form-control" required>
                                                </div>
                                                <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('manage.experience.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="place">Place or Company Name</label>
                        <input type="text" name="place" placeholder="Enter company name" class="form-control" required>
                    </div>

                    <div class="form-group">
                        <label for="description">Description</label>
                        <textarea name="description" id="textarea" cols="30" rows="10" class="form-control" required></textarea>
                    </div>
