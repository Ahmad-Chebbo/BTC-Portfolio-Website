            ...
            <form action="{{ route('manage.social.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="icon" id="social_media" required="please choose icon">
                            <option></option>
            ...
            <form action="{{ route('manage.social.update', $social->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="title">Name</label>
                        <select class="form-control" name="title"  required="">
                            <option value="{{ $social->title }}">{{ $social->title }}</option>
                            <option value="Facebook">Facebook</option>
                            <option value="Twitter">Twitter</option>
                            <option value="Google Plus">Google Plus</option>
                            <option value="Youtube">Youtube</option>
                    ...
                    <div class="form-group">
                        <label for="icon">Icon ( <i class="fa {{ $social->icon }} fa-1x" aria-hidden="true"></i> )</label>
                    ...
                    <div class="form-group">
                        <label for="url">URL</label>
                        <input type="url" name="url" value="{{ $social->url }}" placeholder="Enter url"
