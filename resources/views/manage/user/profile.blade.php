      ...
      <div class="col-md-12">
            <div class="tile mb-4">
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-6">
                              ...
                              <input type="email" name="email" value="{{ $user->email }}"
                                    placeholder="Enter Your User Email" class="form-control" required>
                              </div>
                        </div>
                  </div>
                  <div class="row">
                        <div class="col-md-6">
                              ...
                              <input type="phone" name="phone" value="{{ $user->profile->phone }}" placeholder=""
                                    class="form-control" required>
                              </div>
                        </div>
                        <div class="col-md-6">
                  ...
                  <div class="form-group">
                        ...
                        <textarea class="form-control" name="about" id="textarea" cols="30"
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-4">
                              <div class="form-group">
                              <label for="linkedin">Street</label>
                              <input type="text" value="{{ $user->profile->street }}" name="street" placeholder=""
                                    class="form-control" required>
                              </div>
                        </div>
                        <div class="col-md-4">
