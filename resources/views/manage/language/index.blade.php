        ...
        <div class="modal-content">
            ...
            <form action="{{ route('manage.language.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control" name="name" data-placeholder="Choose a Language..." required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="level" data-placeholder="Choose Level..." required>
...
<div class="modal fade" id="Delete-Modal-{{ $language->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to delete "{{ $language->name }}"?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
