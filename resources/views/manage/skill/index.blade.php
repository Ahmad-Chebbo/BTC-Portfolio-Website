                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="label btn btn-sm btn-circle btn-success ">{{ $skill->percent }}%</span>
                                </td>
                                <td>
                                    <a data-toggle="modal"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('manage.skill.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" max="100" min="0" name="percent" placeholder="Enter percent" class="form-control" required>
                </div>
                </div>
...
<div class="modal fade" id="Edit-Modal-{{ $skill->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit : {{ $skill->skill }}l</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{ route('manage.skill.update', $skill->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="percent">Percent</label>
                    <input type="number" max="100" min="0" name="percent" value="{{ $skill->percent }}" placeholder="Enter Percentage" class="form-control" required>
                </div>
...
<div class="modal fade" id="Delete-Modal-{{ $skill->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Are you sure you want to delete "{{ $skill->skill }}"?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
